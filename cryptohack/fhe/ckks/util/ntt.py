...
from .number_theory import mod_inv as nb_mod_inv, root_of_unity as nb_root_of_unity
...
class NTTContext:
    ...
    def __init__(self, poly_degree, coeff_modulus, root_of_unity=None):
        ...
        if not root_of_unity:
            ...
            # x^d + 1.
            root_of_unity = nb_root_of_unity(order=2 * poly_degree, modulus=coeff_modulus)
    ...
    def precompute_ntt(self, root_of_unity):
        ...
        root_of_unity_inv = nb_mod_inv(root_of_unity, self.coeff_modulus)
    ...
    def ftt_inv(self, coeffs):
        ...
        poly_degree_inv = nb_mod_inv(self.degree, self.coeff_modulus)
...
class FFTContext:
    ...
    def precompute_fft(self):
        ...
        """
        # roots of unity are complex numbers that equal 1 when raised to pow fft_length
        # inv roots of unity are complex numbers that equal -1 when raised to pow fft_length
