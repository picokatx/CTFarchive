...
from .ckks_bootstrapping_context import CKKSBootstrappingContext
    ...
    def multiply_matrix(self, ciph, matrix, rot_keys, encoder):
        ...
        for j in range(matrix_len_factor2):
            ...
            for i in range(matrix_len_factor1):
                diagonal = matrix_operations.diagonal(matrix, shift + i)
                diagonal = matrix_operations.rotate(diagonal, -shift)
