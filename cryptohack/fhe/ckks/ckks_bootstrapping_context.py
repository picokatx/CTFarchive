...
class CKKSBootstrappingContext:
    ...
    def generate_encoding_matrices(self):
        ...
        self.encoding_mat_transpose0 = matrix_operations.transpose_matrix(self.encoding_mat0)
        self.encoding_mat_conj_transpose0 = matrix_operations.conjugate_matrix(
            self.encoding_mat_transpose0)
        self.encoding_mat_transpose1 = matrix_operations.transpose_matrix(self.encoding_mat1)
        self.encoding_mat_conj_transpose1 = matrix_operations.conjugate_matrix(
